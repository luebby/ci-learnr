...
```{r ethik, echo=FALSE}
question("Is it ethical here to conduct a randomized controlled trial?",
...
The following causal structure is assumed due to scientific background knowledge:
...
For the date in this tutorial the smoking and non-smoking group differ by e.g. age. Therefor the naive comparison (without adjusting) was flawed.

The low p-value in the hypothesis test of ${\beta}_{\text{smokeyes}}=0$ gives us (weak) evidence against that the difference was just due to random chance. 

<br>

With this tutorial we try to motivate you to consider bias and confounding in analyzing causal effects. More advanced and non-parametric methods exists. See for a start e.g.: Pearl, J., Glymour, M., \& Jewell, N. P. (2016). [*Causal inference in statistics: A primer*](http://bayes.cs.ucla.edu/PRIMER/). John Wiley \& Sons.
