...
The rather low p-value in the hypothesis test of ${\beta}_{\text{smokeyes}}=0$ gives us a (weak) evidence against just random chance. 

<br>

With this tutorial we try to motivate to consider bias and confounding in analysing causal effects. More advanced and non-parametric methods exists. For a start see e.g.: Pearl, J., Glymour, M., \& Jewell, N. P. (2016). *Causal inference in statistics: A primer*. John Wiley \& Sons, [http://bayes.cs.ucla.edu/PRIMER/](http://bayes.cs.ucla.edu/PRIMER/).
