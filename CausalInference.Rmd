...
With this tutorial we try to motivate you to consider bias and confounding in analyzing causal effects. More advanced and non-parametric methods exist. See for a start e.g.: Pearl, J., Glymour, M., \& Jewell, N. P. (2016). [*Causal inference in statistics: A primer*](http://bayes.cs.ucla.edu/PRIMER/). John Wiley \& Sons.
